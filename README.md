...
Дополнительно построил график зависимости количества эпох от количества ошибк обучения
...
## Выводы
В этой лабораторной работе я познакомился с перцептроном и научился рабтать с ним. Я обучил его вычислять базовые логические операции(OR, AND, NAND, XOR) и 
провёл тесты его рааботы с выборками из 10 и 30 попыток. Во втором задании мной были построены графики зависимости количества эпох от ошибки обучения и график 
зависимости количества эпох от количества ошибк обучения(на основании выборки из 1 задания). Я понял как работает линейная модель перцептрона и узнал про нюансы 
работы одиночного перцептрона на примере XOR. 
